                                                                                                            ...
                                                                                                            module_registration = ['reload_.py'] # add modules that trigger reloading
                                                                                                                ...
                                                                                                                def on_modified(self, event):
                                                                                                                    ...
                                                                                                                    for module in module_registration:
                                                                                                                        if os.path.basename(event.src_path) == module:
                                                                                                                            ...
                                                                                                                            p = Process(target=new_process,args=('reload_.py',))
                                                                                                                            p.start()
                                                                                                                            p.join()
                                                                                                                            return
                                                                                                            ...
                                                                                                            class AppReload(MDApp):
                                                                                                                ...
                                                                                                                def build(self):
                                                                                                                    return MDLabel(text="Hello, World reload 1", halign="center")
